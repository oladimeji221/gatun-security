<div>
    ...
    <section class="page-title-layout1 page-title-light bg-overlay text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">SIA Door Supervisors</h1>
            <nav>
              <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                <li class="breadcrumb-item active" aria-current="page">SIA Door Supervisors</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="service-single-item">
              <div class="service__img text-center">
                <img src="assets/img/sia_door.png" width="500" alt="service" loading="lazy">
              </div><!-- /.service__img -->
              <div class="service__content">
                <h4 class="service__title">SIA Licensed Door Supervisors</h4>
                <p class="service__desc">Gatun Security provides SIA licensed door supervisors to ensure the safety and security of your premises. Our door supervisors are highly trained, experienced, and licensed to handle any situation with professionalism and discretion. We understand the importance of maintaining a safe and enjoyable environment for your patrons, and our team is dedicated to upholding the highest standards of security.
                </p>
                <p class="service__desc">Our door supervisors are skilled in conflict resolution, crowd management, and emergency response. They are trained to identify potential threats and de-escalate situations before they become a problem. Whether you need security for a nightclub, bar, concert, or private event, our door supervisors will provide the peace of mind you need to ensure a successful and secure event.
                </p>
                <h5 class="service__subtitle">Our Door Supervisor Services Include:</h5>
                <ul class="list-items list-unstyled mb-40">
                  ...
                  <li>Patron and Staff Safety</li>
                  <li>Venue Security and Patrols</li>
                </ul>
