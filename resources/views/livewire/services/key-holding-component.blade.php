<div>
    ...
    <section class="page-title-layout1 page-title-light bg-overlay text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Key Holding</h1>
            <nav>
              <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                <li class="breadcrumb-item active" aria-current="page">Key Holding</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="service-single-item">
              <div class="service__img text-center">
                <img src="assets/img/key_holding.png" width="500" alt="service" loading="lazy">
              </div><!-- /.service__img -->
              <div class="service__content">
                <h4 class="service__title">Secure Key Holding Services</h4>
                <p class="service__desc">Gatun Security offers secure key holding services to provide you with peace of mind and a rapid response to any security incidents. Our professional and reliable service ensures that your keys are kept in a secure, off-site location, and are only accessed by authorized personnel. In the event of an alarm activation, our team will respond promptly, assess the situation, and take the necessary action to secure your property.
                </p>
                <p class="service__desc">Our key holding service is tailored to meet your specific needs. We can provide regular patrols of your property, as well as emergency response services. We also offer a lock and unlock service, so you can be sure that your property is secure at all times.
                </p>
                <h5 class="service__subtitle">Our Key Holding Services Include:</h5>
                <ul class="list-items list-unstyled mb-40">
                  <li>Secure Off-Site Key Storage</li>
                  <li>24/7 Alarm Response</li>
                  <li>Property Patrols and Checks</li>
