<div>
    ...
    <section class="page-title-layout1 page-title-light bg-overlay text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Site, Events & Property Security</h1>
            <nav>
              <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                <li class="breadcrumb-item active" aria-current="page">Site, Events & Property Security</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="service-single-item">
              <div class="service__img text-center">
                <img src="assets/img/site_event.png" width="500" alt="service" loading="lazy">
              </div><!-- /.service__img -->
              <div class="service__content">
                <h4 class="service__title">Site, Events & Property Security</h4>
                <p class="service__desc">Gatun Security provides comprehensive security solutions for sites, events, and properties of all sizes. Our experienced and highly trained security personnel are equipped to handle the unique challenges of any environment, from construction sites to large-scale events. We understand the importance of maintaining a safe and secure environment, and our team is dedicated to providing a professional and reliable service.
                </p>
                <p class="service__desc">Our site, event, and property security services are tailored to meet your specific needs. We can provide uniformed or plain-clothed security guards, as well as CCTV monitoring and alarm response services. We also offer a range of other services, including access control, crowd management, and emergency planning.
                </p>
                <h5 class="service__subtitle">Our Services Include:</h5>
                <ul class="list-items list-unstyled mb-40">
                  <li>Construction Site Security</li>
                  <li>Event Security and Crowd Management</li>
                  <li>Residential and Commercial Property Security</li>
