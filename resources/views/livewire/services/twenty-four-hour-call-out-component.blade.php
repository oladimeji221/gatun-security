<div>
    ...
    <section class="page-title-layout1 page-title-light bg-overlay text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">24-Hour Call Out</h1>
            <nav>
              <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                <li class="breadcrumb-item active" aria-current="page">24-Hour Call Out</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="service-single-item">
              <div class="service__img text-center">
                <img src="assets/img/24_hour_call.png" width="500" alt="service" loading="lazy">
              </div><!-- /.service__img -->
              <div class="service__content">
                <h4 class="service__title">24-Hour Call Out</h4>
                <p class="service__desc">Gatun Security provides a 24-hour call out service to ensure that your property is always protected. Our highly trained and experienced team is on standby 24/7 to respond to any security incidents, from alarm activations to emergency situations. We understand the importance of a quick response, and our team is dedicated to providing a professional and efficient service.
                </p>
                <p class="service__desc">Our 24-hour call out service is tailored to meet your specific needs. We can provide a key holding service, so we can access your property in the event of an alarm activation. We can also provide a full report of any incidents, so you can be sure that your property is secure.
                </p>
                <h5 class="service__subtitle">Our 24-Hour Call Out Services Include:</h5>
                <ul class="list-items list-unstyled mb-40">
                  <li>24/7 Emergency Response</li>
                  <li>Alarm Activations and Security Breaches</li>
                  <li>Key Holding and Access Services</li>
                  <li>Property Checks and Patrols</li>
