<div>
    ...
    <section class="page-title-layout1 page-title-light bg-overlay text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Rapid Alarm Response</h1>
            <nav>
              <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                <li class="breadcrumb-item active" aria-current="page">Rapid Alarm Response</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="service-single-item">
              <div class="service__img text-center">
                <img src="assets/img/rapid_alarm.png" width="500"  alt="service" loading="lazy">
              </div><!-- /.service__img -->
              <div class="service__content">
                <h4 class="service__title">Rapid Alarm Response</h4>
                <p class="service__desc">Gatun Security provides a rapid and effective alarm response service to ensure the security of your property. Our highly trained and experienced team is on standby 24/7 to respond to any alarm activations, minimizing the risk of theft, damage, or unauthorized access. We understand the importance of a quick response, and our team is dedicated to providing a professional and efficient service.
                </p>
                <p class="service__desc">Our alarm response service is tailored to meet your specific needs. We can provide a key holding service, so we can access your property in the event of an alarm activation. We can also provide a full report of any incidents, so you can be sure that your property is secure.
                </p>
                <h5 class="service__subtitle">Our Alarm Response Services Include:</h5>
                <ul class="list-items list-unstyled mb-40">
                  <li>24/7 Alarm Monitoring and Response</li>
