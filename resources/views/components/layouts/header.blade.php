        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav__item has-dropdown">
                <a href="index.html#" data-toggle="dropdown" class="dropdown-toggle nav__item-link">Services & Industries</a>
              ...
              <li class="nav__item has-dropdown">
                <a href="index.html#" data-toggle="dropdown" class="dropdown-toggle nav__item-link">News & Media</a>
                <ul class="dropdown-menu">
                  <li class="nav__item">
              ...
              <li class="nav__item has-dropdown">
                <a href="index.html#" data-toggle="dropdown" class="dropdown-toggle nav__item-link">Products</a>
                <ul class="dropdown-menu">
                  <li class="nav__item">
          ...
          <ul class="navbar-actions d-none d-xl-flex align-items-center list-unstyled mb-0">
            ...
            <li>
              <a href="index.html#" class="action__btn action__btn-cart">
                ...
                <ul class="list-unstyled">
                  <li class="cart-item">
                    ...
                    <div class="cart__content">
                      <a class="cart__title" href="https://7oroof.com/demos/sekure/shop-single.html">Broom & Dustpan</a>
                  ...
                  <li class="cart-item">
                    ...
                    <div class="cart__content">
                      <a class="cart__title" href="https://7oroof.com/demos/sekure/shop-single.html">Sponge Cleaner </a>
            ...
            <li>
              <div class="phone__number">
                ...
                <div>
                  ...
                  <a class="email__link d-block" href="https://7oroof.com/cdn-cgi/l/email-protection#0a596f617f786f4a3d657865656c24696567"><span class="__cf_email__" data-cfemail="0d5e6866787f684d3a627f62626b236e6260">[email&#160;protected]</span></a>
                </div>
              </div>
            </li>
          </ul>
